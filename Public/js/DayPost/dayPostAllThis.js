$(function () {
    ...
    $('#day_post_all_this').attr('class','active');
    ...
    $('.form_date').datetimepicker({
        ...
        $('#daily_report').bootstrapTable('refresh', {url: HOST + "index.php/Home/DayPost/getDayPostAllThis?queryDateStart="+$("#dtp_input2").val()+"&type=1"});
    });
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#daily_report').bootstrapTable({
            url: HOST + "index.php/Home/DayPost/getDayPostAllThis",   //请求后台的URL（*）
            method: 'get',      //请求方式（*）
            showExport: true,
            exportDataType: 'all',
