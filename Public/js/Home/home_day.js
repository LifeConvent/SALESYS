...
$(function () {
    ...
    $('.form_date').datetimepicker({
        ...
        $('#daily_report').bootstrapTable('refresh', {url: HOST + "index.php/Home/Method/loadDayPostData?queryDate="+$("#dtp_input2").val()});
    });
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#daily_report').bootstrapTable({
            url: HOST + "index.php/Home/Method/loadDayPostData?queryDate="+$("#dtp_input2").val(),   //请求后台的URL（*）
            method: 'get',      //请求方式（*）
            ...
            columns : [
                [{
                    ...
                    formatter:function(value, row, index){
                        ...
                        if($("#dtp_input2").val() ==''){
                            return ((row.nb_old_count - row.nb_new_count + row.nb_new_count + row.nb_fix_count)*100/row.nb_old_count).toFixed(2)+"%";
                        }
                    ...
                    formatter:function(value, row, index){
                        ...
                        if($("#dtp_input2").val() ==''){
                            return ((row.cs_old_count - row.cs_new_count + row.cs_new_count + row.cs_fix_count)*100/row.cs_old_count).toFixed(2)+"%";
                        }
                    ...
                    formatter:function(value, row, index){
                        ...
                        if($("#dtp_input2").val() ==''){
                            return ((row.clm_old_count - row.clm_new_count + row.clm_new_count + row.clm_fix_count)*100/row.clm_old_count).toFixed(2)+"%";
                        }
