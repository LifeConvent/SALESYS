...
$(function () {
    ...
    $('#cap_define_all').attr('class','active');
    ...
    $('#form_date1').datetimepicker({
        ...
        $('#daily_report2').bootstrapTable('refresh', {url: HOST + "index.php/Home/BxWorkDefine/getCapDefine?queryDateStart="+$('#dtp_input2').val()+"&queryDateEnd="+$('#dtp_input3').val()});
    });
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#daily_report2').bootstrapTable({
            url: HOST + "index.php/Home/BxWorkDefine/getCapDefine",   //请求后台的URL（*）
            method: 'get',      //请求方式（*）
...
window.actionEvents = {
    'click .modify': function (e, value, row, index) {
        ...
        if(description!=""&&description!="-"){
            ...
            $.ajax({
                type: "POST", //用POST方式传输
                url: HOST + "index.php/Home/BxWorkDefine/updateCapDefine", //目标地址.
