...
$(function () {
    ...
    $('#nb_cbyw_define').attr('class','active');
    ...
    $('#form_date1').datetimepicker({
        ...
        $('#daily_report2').bootstrapTable('refresh', {url: HOST + "index.php/Home/PersonDefineFinishWork/getNbCbywDefine?queryDateStart="+$('#dtp_input2').val()+"&queryDateEnd="+$('#dtp_input3').val()});
    });
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#daily_report2').bootstrapTable({
            url: HOST + "index.php/Home/PersonDefineFinishWork/getNbCbywDefine",   //请求后台的URL（*）
            method: 'get',      //请求方式（*）
            showExport: true,
            exportDataType: 'all',
