...
$(function () {
    ...
    $('#yd_post').attr('class','active');
    $('#yd_post_table').css('display','block');
    $('#yd_post_table_tb').attr('class','active');
    ...
    $('#form_date1').datetimepicker({
        ...
        $('#daily_report2').bootstrapTable('refresh', {url: HOST + "index.php/Home/PostTable/getYdPostTb?queryDateStart="+$('#dtp_input2').val()+"&queryDateEnd="+$('#dtp_input3').val()});
    });
...
function exportExcel() {
    ...
    window.location.href = HOST + "index.php/Home/PostTable/expYsPostTb?queryDateStart="+$('#dtp_input2').val()+"&queryDateEnd="+$('#dtp_input3').val()+fix;
}
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#daily_report2').bootstrapTable({
            url: HOST + "index.php/Home/PostTable/getYdPostTb",   //请求后台的URL（*）
            method: 'get',      //请求方式（*）
...
function refreshTable(){
    ...
    $('#daily_report2').bootstrapTable('removeAll');
    $('#daily_report2').bootstrapTable('refresh', {url: HOST + "index.php/Home/PostTable/getYdPostTb?queryDateStart="+$('#dtp_input2').val()+"&queryDateEnd="+$('#dtp_input3').val()+fix});
};