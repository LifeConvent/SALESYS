...
$(function () {
    ...
    $('#form_date1').datetimepicker({
        ...
        $('#daily_report2').bootstrapTable('refresh', {url: HOST + "index.php/Home/DataOut/getCapCs?queryDateStart="+$('#dtp_input2').val()+"&queryDateEnd="+$('#dtp_input3').val()});
    });
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#daily_report2').bootstrapTable({
            url: HOST + "index.php/Home/DataOut/getCapCs",   //请求后台的URL（*）
            method: 'get',      //请求方式（*）
