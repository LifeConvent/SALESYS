            ...
            <!--<li class="sub-menu">-->
                ...
                <!--<ul class="sub" id="data_sub">-->
                    <!--<li id="data_course">-->
                        ...
                        <!--</a>-->
                    <!--</li>-->
                    <!--&lt;!&ndash;<li id="data_sys_course">&ndash;&gt;-->
                        <!--&lt;!&ndash;<a href="<?php echo U('Home/DataManage/sysCourse');?>" style="font-size: 12px;">&ndash;&gt;-->
                            <!--&lt;!&ndash;系统课程维护&ndash;&gt;-->
                        <!--&lt;!&ndash;</a>&ndash;&gt;-->
                    <!--&lt;!&ndash;</li>&ndash;&gt;-->
                    <!--&lt;!&ndash;<li id="data_user_info">&ndash;&gt;-->
                        <!--&lt;!&ndash;<a href="<?php echo U('Home/DataManage/userInfo');?>" style="font-size: 12px;">&ndash;&gt;-->
                            <!--&lt;!&ndash;用户信息维护&ndash;&gt;-->
                        <!--&lt;!&ndash;</a>&ndash;&gt;-->
                    <!--&lt;!&ndash;</li>&ndash;&gt;-->
                    <!--<li id="data_count">-->
            ...
            <div class="container-fluid" >
                <section class="panel">
                    ...
                    <div style="margin:0 5px;margin-top: 10pt;margin-left: 10pt">
                        ...
                        <div>
                            <input class="form-control" value="保全受理" style="width:70pt;float:left;">
                            <input class="form-control" value="保全复核" style="width:70pt;float:left;margin-left: 5pt">
                            <input class="form-control" value="理赔受理" style="width:70pt;float:left;margin-left: 5pt">
                            <input class="form-control" value="契约核保" style="width:70pt;float:left;margin-left: 5pt">
                            <input class="form-control" value="保全核保" style="width:70pt;float:left;margin-left: 5pt">
                            <input class="form-control" value="理赔核保" style="width:70pt;float:left;margin-left: 5pt">
                            <input class="form-control" value="出单前撤保" style="width:80pt;float:left;margin-left: 5pt">
                            <input class="form-control" value="保单回执" style="width:70pt;float:left;margin-left: 5pt">
                        </div>
