        ...
        <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub" id="data_ub">
                    ...
                    <li id="cs_difine">
                        <a href="<?php echo U('Home/PersonDefineFinishWork/csDefine');?>" style="font-size: 12px;">
                            保全柜面
                        </a>
                    </li>
                </ul>
...
<!-- 边栏 -->
    ...
    <section id="main-content">
        ...
        <section class="wrapper">
            ...
            <div class="col-sm-12" style="color:#5eb7dd;">
                <section class="panel">
            ...
            <div class="col-sm-12" style="color:#fd6d4d;">
                <section class="panel">
                    <header class="panel-heading">
                        理赔作业数量变化趋势
                    </header>
            ...
            <div class="col-sm-12" style="color:#f7d254;">
                <section class="panel">
                    <header class="panel-heading">
                        契约作业数量变化趋势
                    </header>
            ...
            <div class="col-sm-12" style="color:#a560f8">
                <section class="panel">
                    <header class="panel-heading">
                        TC缺陷数量变化趋势
                    </header>
...
<!-- 尾 -->
    ...
    <p id="cs_time" style="display:none"><?php echo ($cs_time); ?></p>

    <p id="clm_time" style="display:none"><?php echo ($clm_time); ?></p>

    <p id="nb_time" style="display:none"><?php echo ($nb_time); ?></p>

    <p id="tc_time" style="display:none"><?php echo ($tc_time); ?></p>
</section>
<!-- SECTION -->
