    ...
    <section id="main-content">
        ...
        <section class="wrapper">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-sm-12" style="padding-top:10pt;">
                                <div class="col-sm-3"><span class="red">*</span><span><strong>作业机构名称: 分公司核保室/平度柜面...</strong></span><input type="text" class="form-control add_user" id="user_organ_name" placeholder="请输入作业机构名称"></div>
                                <div class="col-sm-3"><span class="red">*</span><span><strong>用户性别: 男/女</strong></span><input type="text" class="form-control add_user" id="user_sex" placeholder="请输入用户性别"></div>
                                <div class="col-sm-3"><span class="red">*</span><span><strong>所属公司: 总公司/河北分公司/高伟达...</strong></span><input type="text" class="form-control add_user" id="user_company" placeholder="请输入所属公司"></div>
                                <div class="col-sm-3"><span class="red">*</span><span><strong>作业范围: 柜面操作/技术支持...</strong></span><input type="text" class="form-control add_user" id="buss_area" placeholder="请输入作业范围"></div>
                            </div>
                            <div class="col-sm-12" style="padding-top:10pt;">
                ...
                <div>
                    <section class="panel">
                        <header class="panel-heading">
                            <span><strong>用户信息列表</strong></span>
                        </header>
