                ...
                <div>
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="col-sm-2"><input type="text" class="form-control" id="user_account" placeholder="请输入用户账号"></div>
                            <div class="col-sm-2"><input type="text" class="form-control" id="user_pass" placeholder="请输入用户密码"></div>
                            <div><button type="button" id="new_user" class="btn btn-primary exportreport" style="float:left;margin-left: 10pt">添加用户信息</button></div>
                        </div>
                    </section>
                </div>
                <!--<div>-->
