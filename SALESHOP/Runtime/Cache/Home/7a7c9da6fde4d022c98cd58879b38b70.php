...
<head>
    ...
    <link href="/SALESYS/Public/assets/morris.js-0.4.3/morris.css" rel="stylesheet"><!-- MORRIS CHART CSS -->
    <!--dashboard calendar-->
    <link href="/SALESYS/Public/css/clndr.css" rel="stylesheet"><!-- CALENDER CSS -->
    <!--[if lt IE 9]>
...
<!--统计框Morris-->
<script src="/SALESYS/Public/assets/morris.js-0.4.3/morris.min.js"></script><!-- MORRIS JS -->
<script src="/SALESYS/Public/assets/morris.js-0.4.3/raphael-min.js"></script><!-- MORRIS  JS -->
<script src="/SALESYS/Public/js/chart.js"></script><!-- CHART JS -->

<!--自定义-->
<script src="/SALESYS/Public/js/Home/count.js"></script>
<script src="/SALESYS/Public/js/Home/get-time.js"></script>
<script src="/SALESYS/Public/js/Home/charts-home.js"></script>
<script src="/SALESYS/Public/js/Home/home.js"></script>
<script>
